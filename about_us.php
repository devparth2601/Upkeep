...
<!-- Mirrored from webstrot.com/html/typhoon/typhoon_html/about_us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 06:36:40 GMT -->
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="sw_abot_top_txt_wrapper">
                        ...
                        <div class="sw_left_heading_wraper sw_dark_heading_wraper">
                            ...
                            <p>We are on a mission to improve reliability of solar plants and enhance trust people place in rooftop solar systems. We are here to make sure that whoever is using solar enery should be toruble free to use it effectively.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="sw_left_heading_wraper sw_abt_tp_txt">
                        ...
                        <p>So why are you experiencing a loss? The panels convert the sun’s energy into electricity, so the more sun that reaches the panels the more energy you produce. If dirt, dust, salt water residue, bird droppings, and other environmental pollutants are on your solar panels, it could be preventing sunlight from reaching the solar cells. According to the national Renewable Energy Laboratory, losses range up to 30%.  A simple, inexpensive solar cleaning will drastically decrease your loss.
                        </p>
                        <br>
                        <p>Who should do the cleaning? We have seen many system owners get on a ladder and hose the panels down, but this is not good for a number of reasons. Getting on a ladder should be avoided if you are not a trained professional. Just hosing down a panel will only wash off about 10-30% of the dirt and leave hard water residue. The panels normally need a good scrubbing from a soft brush and a rinse from a pure water system.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="sw_abt_right_btm_wrapper">
                        ...
                        <div class="sw_left_heading_wraper">
                            <h1>Our Mission</h1>
                            <img src="images/heading_line.png" alt="title">
                            <p>Our mission is to create and share best practices across the solar buying and owning journey for any roof owner. To make it more reliable, we are getting into the field.
                        ...
                        <div class="sw_left_heading_wraper">
                            <h1>Our vision</h1>
                            <img src="images/heading_line.png" alt="title">
                            <p>We are starting with solar post-installation services because we understand that this has been an area completely ignored by most people and companies and has a significant impact on the value an individual get out of solar.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="sw_news_letter_wrapper">
        <div class="container">
            <div class="sw_nl_heading_wrapper">
                ...
                <h2>Call Today For A Free Estimate</h2>
            ...
            <div class="sw_nl_form_wrapper sw_about_inner_btn">
                ...
                <div class="disc_btn ltr_btn">
                    <ul>
                        <li>
                            <a href="contact_us.php" class="waves-effect waves-light waves-ripple">CONTACT</a>
                        </li>
                    </ul>
